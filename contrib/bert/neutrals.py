...
from readers.rusentrel_neutrals_io import RuSentRelNeutralIOUtils


# TODO. Remove this file and class.
# TODO. Utilize already impelmented.
class RuSentRelNeutralAnnotationCreator:
    ...
    def __init__(self, stemmer, synonyms):
    ...
    def create(self, is_train):
        ...
        for doc_id in RuSentRelIOUtils.iter_collection_indices():
            ...
            neutral_filepath = RuSentRelNeutralIOUtils.get_rusentrel_neutral_opin_filepath(
                doc_id=doc_id,
                is_train=is_train)
    ...
    def __create_opinions_between_entities(self, relevant_pairs, entities_collection):
        ...
        for e1 in entities_collection:
            ...
            for e2 in entities_collection:
                ...
                opinion = Opinion(e1.Value, e2.Value, NeutralLabel())
