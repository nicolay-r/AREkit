...
class RuSentRelDefaultNeutralOpinionAnnotationAlgorithm(PairBasedOpinionAnnotationAlgorithm):
    ...
    def __is_entity_ignored(e, e_type):
        ...
        return e.Value in RuSentRelDefaultNeutralOpinionAnnotationAlgorithm.IGNORED_ENTITY_VALUES

    def __init__(self, dist_in_terms_bound):
        label_provider = ConstantLabelProvider(label_instance=ExperimentNeutralLabel())
        super(RuSentRelDefaultNeutralOpinionAnnotationAlgorithm, self).__init__(
            dist_in_sents=0,
