...
class TestRuSentRel(unittest.TestCase):
    ...
    def test_reading(self):
        ...
        for doc, opinions in self.__iter_by_docs(synonyms):
            logger.info("DocID: {}".format(doc.ID))
    ...
    def test_linked_text_opinion_extraction(self):
        ...
        for doc, opinions in self.__iter_by_docs(synonyms):
            ...
            # Example: Access to document text-level opinions.
            ...
            # Parse text.
            parsed_news = NewsParser.parse(news=doc, text_parser=text_parser)
